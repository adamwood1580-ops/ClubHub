(function () {
    ...
    /*
     * The current application bootstrap still exposes the legacy
     * internal window.BookIt namespace. Visible branding is ClubHub.
     * The namespace will be renamed in the planned project-wide sweep.
     */
    ...
    function getClient() {
        ...
        throw new Error(
            "The ClubHub data service is unavailable."
        );
    }
    ...
    async function initialiseAdminPage() {
        ...
        try {
            if (!window.BookIt.ready) {
                throw new Error(
                    "ClubHub has not finished initialising."
                );
            }
